...
<section class="terminos-condiciones divBoxPrincipal" id=" terminos-condiciones">
<br>
<nav  class="d-flex justify-content-center" style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item navbar-brand" aria-current="page">Terminos y Usos</li>
  </ol>
</nav>
...
<style>
    ...
    .text-primary {
        color:rgb(234, 241, 241) !important;
    }
</style>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        Realización de Pedidos de Compra y Conclusión del Contrato de Compraventa
                    </button>
                </h2>
                <div id="flush-collapseTwo" class="accordion-collapse collapse"
                    data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                    <p class="text-center"> Una vez que seleccione los productos que desee adquirir, estos se añadirán a su carrito de compra.
...
- Incumplimiento de condiciones de compra.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div id="flush-collapseThree" class="accordion-collapse collapse"
                    ...
                    <div class="accordion-body">
                    <p class="text-center">
Los productos serán entregados en la dirección indicada por el cliente durante el proceso de compra. Las entregas se realizan únicamente en días hábiles y dentro del territorio nacional, a través de empresas de mensajería autorizadas. El tiempo estimado de entrega será de 3 a 7 días hábiles, dependiendo de la ubicación del cliente.
            ...
            <div class="accordion-item">
                <h2 class="accordion-header">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        Devoluciones y cancelación del pedido
                    </button>
                </h2>
                <div id="flush-collapseFour" class="accordion-collapse collapse"
                    data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                    <p class="text-center"> <strong>CANCELACIÓN:</strong> Puede cancelar su pedido dentro de los 3 días posteriores a la compra. Para ello, deberá devolver previamente los productos en perfecto estado. De lo contrario, podremos deducir el costo de recuperación.

<strong>PRODUCTOS DEFECTUOSOS O ERRÓNEOS:</strong><br>
i. <u>Cambio:</u> Si los productos están dañados o son incorrectos, se reemplazarán sin cargo adicional, siempre que sean devueltos en el mismo estado en que se recibieron.<br>
ii. <u>Reembolso:</u> En caso de devolución de productos dañados o incorrectos, se reembolsará el importe completo del pedido.

Si corresponde, reembolsaremos los gastos de envío presentando copia del recibo de la oficina de correos.
</p>
                    </div>
                </div>
            </div>

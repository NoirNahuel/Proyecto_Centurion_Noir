...
<div class="container my-5">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card card-custom bg-light text-dark p-4">
                <h2 class="text-center text-uppercase fw-bold">Completar Datos Adicionales para su compra</h2>
                ...
                <form action="<?= base_url('guardar-datos-compra') ?>" method="post" class="needs-validation" novalidate>
    ...
    <div class="row g-3">
        ...
        <div class="col-md-12 text-center mt-3">
            <button type="submit" class="btn btn-primary w-50">Continuar</button>
        </div>
    </div>
</form>
